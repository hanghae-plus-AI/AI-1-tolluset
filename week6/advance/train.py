...
# raw_datasets = load_dataset("json", data_files="corpus.json", split="train")
...
def tokenize_function(examples):
    print("text_column_names", text_column_name)
    print("exmamples", examples)

    output = tokenizer(examples["content"], truncation=True)
    return output
...
valid_dataset = lm_datasets["test"]
...
trainer = Trainer(
    ...
    eval_dataset=valid_dataset,  # ✅ Validation data 준비
    tokenizer=tokenizer,
...
trainer.log_metrics("valid", eval_result)
trainer.save_metrics("valid", eval_result)
